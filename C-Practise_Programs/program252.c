// Append the data of one file at the end of another file
// (open the first file then Copy the data of 1st file then paste the data of first file in the last of second file )
...
int main()
{
    ...
    printf("Enter the file name that you want to open and print the data\n");
    scanf("%s",Fname2);
